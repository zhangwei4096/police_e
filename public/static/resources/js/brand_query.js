...
function optFormater(value, rowData, rowIndex) {
	...
	return 	"<a href=\""+root+"/user/goUpdateBrand/"+brandId+"\" class=\"icon icon-edit\" title=\"编辑\"></a>  "+
            "<a href=\""+root+"/user/deleteBrand/"+brandId+"\" onclick=\"return confirm('确定删除此条数据？');\" class=\"icon icon-cancel\" title=\"删除\"></a> ";
}
